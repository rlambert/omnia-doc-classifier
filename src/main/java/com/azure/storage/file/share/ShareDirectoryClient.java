 ...
 * @see com.azure.storage.file.share.ShareDirectoryClient
...
public class ShareDirectoryClient {
     ...
     *
     * <p>If the file doesn't exist in this directory {@link com.azure.storage.file.share.ShareDirectoryClient#create()} create} in the client will
     ...
     */
    public com.azure.storage.file.share.ShareDirectoryClient getSubdirectoryClient(String subdirectoryName) {
        return new com.azure.storage.file.share.ShareDirectoryClient(shareDirectoryAsyncClient.getSubdirectoryClient(subdirectoryName));
    }
     ...
     */
    public com.azure.storage.file.share.ShareDirectoryClient createSubdirectory(String subdirectoryName) {
     ...
     * @throws RuntimeException if the operation doesn't complete before the timeout concludes.
     */
    public Response<com.azure.storage.file.share.ShareDirectoryClient> createSubdirectoryWithResponse(String subdirectoryName,
                                                                                                      FileSmbProperties smbProperties, String filePermission, Map<String, String> metadata, Duration timeout,
                                                                                                      Context context) {
        com.azure.storage.file.share.ShareDirectoryClient shareDirectoryClient = getSubdirectoryClient(subdirectoryName);
    ...
    /**
     * Get snapshot id which attached to {@link com.azure.storage.file.share.ShareDirectoryClient}. Return {@code null} if no snapshot id attached.
     *
     * <p><strong>Code Samples</strong></p>
     *
