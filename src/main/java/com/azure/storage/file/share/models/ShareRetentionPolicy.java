...
public final class ShareRetentionPolicy {
     ...
     */
    public com.azure.storage.file.share.models.ShareRetentionPolicy setEnabled(boolean enabled) {
     ...
     * @return the ShareRetentionPolicy object itself.
     */
    public com.azure.storage.file.share.models.ShareRetentionPolicy setDays(Integer days) {
        this.days = days;
        return this;
    }
}
