...
public enum CopyStatusType {
     ...
     */
    @JsonCreator
    public static com.azure.storage.file.share.models.CopyStatusType fromString(String value) {
        com.azure.storage.file.share.models.CopyStatusType[] items = values();
        for (com.azure.storage.file.share.models.CopyStatusType item : items) {
