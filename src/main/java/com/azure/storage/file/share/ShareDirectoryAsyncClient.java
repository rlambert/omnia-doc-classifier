...
public class ShareDirectoryAsyncClient {
    private final ClientLogger logger = new ClientLogger(com.azure.storage.file.share.ShareDirectoryAsyncClient.class);
    ...
    public String getDirectoryUrl() {
        ...
        StringBuilder directoryUrlString = new StringBuilder(120);
        directoryUrlString.append(azureFileStorageClient.getUrl()).append("/").append(shareName);
        if (!directoryPath.startsWith("/")) {
            directoryUrlString.append("/");
        }
        directoryUrlString.append(directoryPath);
        if (snapshot != null) {
     ...
     *
     * <p>If the file doesn't exist in this directory {@link com.azure.storage.file.share.ShareDirectoryAsyncClient#create()} create} in the client
     ...
     */
    public com.azure.storage.file.share.ShareDirectoryAsyncClient getSubdirectoryClient(String subdirectoryName) {
        String directoryPath = this.directoryPath + "/" + subdirectoryName;
        return new com.azure.storage.file.share.ShareDirectoryAsyncClient(azureFileStorageClient, shareName, directoryPath, snapshot, accountName,
            serviceVersion);
    }
     ...
     */
    public Mono<com.azure.storage.file.share.ShareDirectoryAsyncClient> createSubdirectory(String subdirectoryName) {
        try {
     ...
     */
    public Mono<Response<com.azure.storage.file.share.ShareDirectoryAsyncClient>> createSubdirectoryWithResponse(String subdirectoryName,
    ...
    Mono<Response<com.azure.storage.file.share.ShareDirectoryAsyncClient>> createSubdirectoryWithResponse(String subdirectoryName,
                                                                                                          FileSmbProperties smbProperties, String filePermission, Map<String, String> metadata, Context context) {
        com.azure.storage.file.share.ShareDirectoryAsyncClient createSubClient = getSubdirectoryClient(subdirectoryName);
    ...
    Mono<Response<Void>> deleteSubdirectoryWithResponse(String subdirectoryName, Context context) {
        com.azure.storage.file.share.ShareDirectoryAsyncClient deleteSubClient = getSubdirectoryClient(subdirectoryName);
    ...
    /**
     * Get snapshot id which attached to {@link com.azure.storage.file.share.ShareDirectoryAsyncClient}. Return {@code null} if no snapshot id
     * attached.
     *
     * <p><strong>Code Samples</strong></p>
     *
