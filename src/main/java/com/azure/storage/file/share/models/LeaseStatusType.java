...
public enum LeaseStatusType {
     ...
     */
    @JsonCreator
    public static com.azure.storage.file.share.models.LeaseStatusType fromString(String value) {
        com.azure.storage.file.share.models.LeaseStatusType[] items = values();
        for (com.azure.storage.file.share.models.LeaseStatusType item : items) {
