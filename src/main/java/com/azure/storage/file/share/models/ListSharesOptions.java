 ...
 * <ul>
 *     <li>
 *         Providing {@link com.azure.storage.file.share.models.ListSharesOptions#setPrefix(String) prefix} will filter selections to
 *         {@link ShareItem shares} that that begin with the prefix.
 *     </li>
 *     <li>
 *         Providing {@link com.azure.storage.file.share.models.ListSharesOptions#setMaxResultsPerPage(Integer) maxResultsPerPage} will limit the number of
 *         {@link ShareItem shares} returned in a single page.
 *     </li>
 *     <li>
 *         Setting {@link com.azure.storage.file.share.models.ListSharesOptions#setIncludeMetadata(boolean) includeMetadata} to true will include the
 *         metadata of each {@link ShareItem share}, if false {@link ShareItem#getMetadata()}  metadata} for each share
 *         will be {@code null}.
 *     </li>
 *     <li>
 *         Setting {@link com.azure.storage.file.share.models.ListSharesOptions#setIncludeSnapshots(boolean) includeSnapshots} to true will include
...
public final class ListSharesOptions {
     ...
     */
    public com.azure.storage.file.share.models.ListSharesOptions setPrefix(String prefix) {
        this.prefix = prefix;
        return this;
    }
     ...
     * @return An updated ListSharesOptions object
     */
    public com.azure.storage.file.share.models.ListSharesOptions setMaxResultsPerPage(Integer maxResultsPerPage) {
     ...
     * @return An updated ListSharesOptions object
     */
    public com.azure.storage.file.share.models.ListSharesOptions setIncludeMetadata(boolean includeMetadata) {
     ...
     * @return An updated ListSharesOptions object
     */
    public com.azure.storage.file.share.models.ListSharesOptions setIncludeSnapshots(boolean includeSnapshots) {
