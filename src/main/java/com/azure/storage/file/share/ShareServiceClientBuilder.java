 ...
 * com.azure.storage.file.share.ShareServiceClientBuilder#buildClient() buildClient} constructs an instance of ShareServiceClient and calling {@link
 * com.azure.storage.file.share.ShareServiceClientBuilder#buildAsyncClient() buildFileAsyncClient} constructs an instance of ShareServiceAsyncClient.
 *
 * <p>The client needs the endpoint of the Azure Storage File service and authorization credential.
 * {@link com.azure.storage.file.share.ShareServiceClientBuilder#endpoint(String) endpoint} gives the builder the endpoint and may give the builder a
 ...
 * StorageSharedKeyCredential with {@link com.azure.storage.file.share.ShareServiceClientBuilder#connectionString(String) connectionString}.
...
public final class ShareServiceClientBuilder {
    private final ClientLogger logger = new ClientLogger(com.azure.storage.file.share.ShareServiceClientBuilder.class);
     ...
     *
     * <p>
     * If {@link com.azure.storage.file.share.ShareServiceClientBuilder#pipeline(HttpPipeline) pipeline} is set, then the {@code pipeline} and
     * {@link com.azure.storage.file.share.ShareServiceClientBuilder#endpoint(String) endpoint} are used to create the
     ...
     *
     * <p>
     * If {@link com.azure.storage.file.share.ShareServiceClientBuilder#pipeline(HttpPipeline) pipeline} is set, then the {@code pipeline} and {@link
     * com.azure.storage.file.share.ShareServiceClientBuilder#endpoint(String) endpoint} are used to create the {@link ShareServiceClient client}.
     ...
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder endpoint(String endpoint) {
        try {
     ...
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder credential(StorageSharedKeyCredential credential) {
     ...
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder sasToken(String sasToken) {
     ...
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder connectionString(String connectionString) {
     ...
     * @return the updated ShareServiceClientBuilder object
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder httpClient(HttpClient httpClient) {
     ...
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder addPolicy(HttpPipelinePolicy pipelinePolicy) {
     ...
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder httpLogOptions(HttpLogOptions logOptions) {
     ...
     * @return the updated ShareServiceClientBuilder object
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder configuration(Configuration configuration) {
     ...
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder retryOptions(RequestRetryOptions retryOptions) {
     ...
     * @return the updated ShareServiceClientBuilder object
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder pipeline(HttpPipeline httpPipeline) {
     ...
     * @return the updated ShareServiceClientBuilder object
     */
    public com.azure.storage.file.share.ShareServiceClientBuilder serviceVersion(ShareServiceVersion version) {
