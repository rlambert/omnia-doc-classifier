...
public enum ListSharesIncludeType {
     ...
     */
    @JsonCreator
    public static com.azure.storage.file.share.implementation.models.ListSharesIncludeType fromString(String value) {
        com.azure.storage.file.share.implementation.models.ListSharesIncludeType[] items = values();
        for (com.azure.storage.file.share.implementation.models.ListSharesIncludeType item : items) {
