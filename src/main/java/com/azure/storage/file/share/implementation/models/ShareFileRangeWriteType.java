...
public enum ShareFileRangeWriteType {
     ...
     */
    @JsonCreator
    public static com.azure.storage.file.share.implementation.models.ShareFileRangeWriteType fromString(String value) {
        com.azure.storage.file.share.implementation.models.ShareFileRangeWriteType[] items = values();
        for (com.azure.storage.file.share.implementation.models.ShareFileRangeWriteType item : items) {
