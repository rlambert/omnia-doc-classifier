 ...
 * {@link ShareServiceSasSignatureValues#setPermissions(com.azure.storage.file.share.sas.ShareFileSasPermission) ShareServiceSasSignatureValues}.
 *
 * <p>
...
public final class ShareFileSasPermission {
     ...
     */
    public static com.azure.storage.file.share.sas.ShareFileSasPermission parse(String permString) {
        com.azure.storage.file.share.sas.ShareFileSasPermission permissions = new com.azure.storage.file.share.sas.ShareFileSasPermission();
     ...
     */
    public com.azure.storage.file.share.sas.ShareFileSasPermission setReadPermission(boolean hasReadPermission) {
     ...
     * @return the updated ShareFileSasPermission object
     */
    public com.azure.storage.file.share.sas.ShareFileSasPermission setCreatePermission(boolean hasCreatePermission) {
     ...
     * @return the updated ShareFileSasPermission object
     */
    public com.azure.storage.file.share.sas.ShareFileSasPermission setWritePermission(boolean hasWritePermission) {
     ...
     * @return the updated ShareFileSasPermission object
     */
    public com.azure.storage.file.share.sas.ShareFileSasPermission setDeletePermission(boolean hasDeletePermission) {
