...
public enum LeaseStateType {
     ...
     */
    @JsonCreator
    public static com.azure.storage.file.share.models.LeaseStateType fromString(String value) {
        com.azure.storage.file.share.models.LeaseStateType[] items = values();
        for (com.azure.storage.file.share.models.LeaseStateType item : items) {
