 ...
 * ShareClients} and {@link ShareAsyncClient ShareAsyncClients}, calling {@link com.azure.storage.file.share.ShareClientBuilder#buildClient()
 * buildClient} constructs an instance of ShareClient and calling {@link com.azure.storage.file.share.ShareClientBuilder#buildAsyncClient()
 ...
 * {@link com.azure.storage.file.share.ShareClientBuilder#endpoint(String) endpoint} gives the builder the endpoint and may give the builder the
 * {@link com.azure.storage.file.share.ShareClientBuilder#shareName(String) shareName} and a {@link #sasToken(String) SAS token} that authorizes the
 * client.</p>
 *
 ...
 * StorageSharedKeyCredential with {@link com.azure.storage.file.share.ShareClientBuilder#connectionString(String) connectionString}.
...
public class ShareClientBuilder {
    private final ClientLogger logger = new ClientLogger(com.azure.storage.file.share.ShareClientBuilder.class);
     ...
     *
     * <p>
     * If {@link com.azure.storage.file.share.ShareClientBuilder#pipeline(HttpPipeline) pipeline} is set, then the {@code pipeline} and {@link
     * com.azure.storage.file.share.ShareClientBuilder#endpoint(String) endpoint} are used to create the {@link ShareAsyncClient client}. All other
     ...
     * <p>
     * If {@link com.azure.storage.file.share.ShareClientBuilder#pipeline(HttpPipeline) pipeline} is set, then the {@code pipeline} and {@link
     * com.azure.storage.file.share.ShareClientBuilder#endpoint(String) endpoint} are used to create the {@link ShareClient client}. All other
     * builder settings are ignored.
     * </p>
     *
     ...
     */
    public com.azure.storage.file.share.ShareClientBuilder endpoint(String endpoint) {
        try {
     ...
     * @throws NullPointerException If {@code shareName} is {@code null}.
     */
    public com.azure.storage.file.share.ShareClientBuilder shareName(String shareName) {
     ...
     * @return the updated ShareClientBuilder object
     */
    public com.azure.storage.file.share.ShareClientBuilder snapshot(String snapshot) {
     ...
     */
    public com.azure.storage.file.share.ShareClientBuilder credential(StorageSharedKeyCredential credential) {
     ...
     */
    public com.azure.storage.file.share.ShareClientBuilder sasToken(String sasToken) {
     ...
     */
    public com.azure.storage.file.share.ShareClientBuilder connectionString(String connectionString) {
     ...
     * @return the updated ShareClientBuilder object
     */
    public com.azure.storage.file.share.ShareClientBuilder httpClient(HttpClient httpClient) {
     ...
     */
    public com.azure.storage.file.share.ShareClientBuilder addPolicy(HttpPipelinePolicy pipelinePolicy) {
     ...
     */
    public com.azure.storage.file.share.ShareClientBuilder httpLogOptions(HttpLogOptions logOptions) {
     ...
     * @return the updated ShareClientBuilder object
     */
    public com.azure.storage.file.share.ShareClientBuilder configuration(Configuration configuration) {
     ...
     */
    public com.azure.storage.file.share.ShareClientBuilder retryOptions(RequestRetryOptions retryOptions) {
     ...
     * @return the updated ShareClientBuilder object
     */
    public com.azure.storage.file.share.ShareClientBuilder pipeline(HttpPipeline httpPipeline) {
     ...
     * @return the updated ShareClientBuilder object
     */
    public com.azure.storage.file.share.ShareClientBuilder serviceVersion(ShareServiceVersion version) {
