...
public enum PermissionCopyModeType {
     ...
     */
    @JsonCreator
    public static com.azure.storage.file.share.models.PermissionCopyModeType fromString(String value) {
        com.azure.storage.file.share.models.PermissionCopyModeType[] items = values();
        for (com.azure.storage.file.share.models.PermissionCopyModeType item : items) {
