...
public class ShareSasImplUtil {
    ...
    private final ClientLogger logger = new ClientLogger(com.azure.storage.file.share.implementation.util.ShareSasImplUtil.class);
    ...
    /**
     * Creates a new {@link com.azure.storage.file.share.implementation.util.ShareSasImplUtil} with the specified parameters
     *
