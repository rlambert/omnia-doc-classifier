...
public class ShareFileClient {
    private final ClientLogger logger = new ClientLogger(com.azure.storage.file.share.ShareFileClient.class);
    ...
    /**
     * Get snapshot id which attached to {@link com.azure.storage.file.share.ShareFileClient}. Return {@code null} if no snapshot id attached.
     *
     * <p><strong>Code Samples</strong></p>
     *
