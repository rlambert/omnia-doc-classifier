...
public enum LeaseDurationType {
     ...
     */
    @JsonCreator
    public static com.azure.storage.file.share.models.LeaseDurationType fromString(String value) {
        com.azure.storage.file.share.models.LeaseDurationType[] items = values();
        for (com.azure.storage.file.share.models.LeaseDurationType item : items) {
