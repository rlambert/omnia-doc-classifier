...
public final class HandleItem {
     ...
     */
    public com.azure.storage.file.share.models.HandleItem setHandleId(String handleId) {
     ...
     * @return the HandleItem object itself.
     */
    public com.azure.storage.file.share.models.HandleItem setPath(String path) {
        this.path = path;
        return this;
    }
     ...
     * @return the HandleItem object itself.
     */
    public com.azure.storage.file.share.models.HandleItem setFileId(String fileId) {
        this.fileId = fileId;
        return this;
    }
     ...
     * @return the HandleItem object itself.
     */
    public com.azure.storage.file.share.models.HandleItem setParentId(String parentId) {
     ...
     * @return the HandleItem object itself.
     */
    public com.azure.storage.file.share.models.HandleItem setSessionId(String sessionId) {
     ...
     * @return the HandleItem object itself.
     */
    public com.azure.storage.file.share.models.HandleItem setClientIp(String clientIp) {
     ...
     * @return the HandleItem object itself.
     */
    public com.azure.storage.file.share.models.HandleItem setOpenTime(OffsetDateTime openTime) {
        if (openTime == null) {
            this.openTime = null;
        } else {
     ...
     * @return the HandleItem object itself.
     */
    public com.azure.storage.file.share.models.HandleItem setLastReconnectTime(OffsetDateTime lastReconnectTime) {
