...
public final class AzureFileStorageBuilder {
     ...
     */
    public com.azure.storage.file.share.implementation.AzureFileStorageBuilder version(String version) {
     ...
     * @return the AzureFileStorageBuilder.
     */
    public com.azure.storage.file.share.implementation.AzureFileStorageBuilder url(String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the AzureFileStorageBuilder.
     */
    public com.azure.storage.file.share.implementation.AzureFileStorageBuilder pipeline(HttpPipeline pipeline) {
