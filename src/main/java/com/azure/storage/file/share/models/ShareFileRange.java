...
public final class ShareFileRange {
    final ClientLogger logger = new ClientLogger(com.azure.storage.file.share.models.ShareFileRange.class);
    ...
    /**
     * @return {@link com.azure.storage.file.share.models.ShareFileRange#toString()} if {@code count} isn't {@code null} or {@code offset} isn't 0,
     * otherwise null.
     */
