 ...
 * {@link com.azure.storage.file.share.ShareFileClientBuilder#buildFileClient() buildFileClient},
 * {@link com.azure.storage.file.share.ShareFileClientBuilder#buildFileAsyncClient() buildFileAsyncClient},
 * {@link com.azure.storage.file.share.ShareFileClientBuilder#buildDirectoryClient() buildDirectoryClient}, or
 * {@link com.azure.storage.file.share.ShareFileClientBuilder#buildDirectoryAsyncClient() buildDirectoryAsyncClient} constructs
 ...
 * {@link com.azure.storage.file.share.ShareFileClientBuilder#endpoint(String) endpoint} gives the builder the endpoint and may give the builder the
 * {@link com.azure.storage.file.share.ShareFileClientBuilder#shareName(String)}, {@link com.azure.storage.file.share.ShareFileClientBuilder#resourcePath(String)} and a
 ...
 * Set the StorageSharedKeyCredential with {@link com.azure.storage.file.share.ShareFileClientBuilder#connectionString(String) connectionString}.
...
public class ShareFileClientBuilder {
    private final ClientLogger logger = new ClientLogger(com.azure.storage.file.share.ShareFileClientBuilder.class);
     ...
     *
     * <p>
     * If {@link com.azure.storage.file.share.ShareFileClientBuilder#pipeline(HttpPipeline) pipeline} is set, then the {@code pipeline} and {@link
     * com.azure.storage.file.share.ShareFileClientBuilder#endpoint(String) endpoint} are used to create the
     ...
     * <p>
     * If {@link com.azure.storage.file.share.ShareFileClientBuilder#pipeline(HttpPipeline) pipeline} is set, then the {@code pipeline} and {@link
     * com.azure.storage.file.share.ShareFileClientBuilder#endpoint(String) endpoint} are used to create the {@link ShareDirectoryClient client}.
     ...
     * <p>
     * If {@link com.azure.storage.file.share.ShareFileClientBuilder#pipeline(HttpPipeline) pipeline} is set, then the {@code pipeline} and {@link
     * com.azure.storage.file.share.ShareFileClientBuilder#endpoint(String) endpoint} are used to create the {@link ShareFileAsyncClient client}.
     * All other builder settings are ignored.
     * </p>
     *
     * @return A ShareAsyncClient with the options set from the builder.
     ...
     * <p>
     * If {@link com.azure.storage.file.share.ShareFileClientBuilder#pipeline(HttpPipeline) pipeline} is set, then the {@code pipeline} and {@link
     * com.azure.storage.file.share.ShareFileClientBuilder#endpoint(String) endpoint} are used to create the {@link ShareFileClient client}.
     * All other builder settings are ignored.
     * </p>
     *
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder endpoint(String endpoint) {
        try {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder shareName(String shareName) {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder snapshot(String snapshot) {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder resourcePath(String resourcePath) {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder credential(StorageSharedKeyCredential credential) {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder sasToken(String sasToken) {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder connectionString(String connectionString) {
     ...
     * @return the updated ShareFileClientBuilder object
     */
    public com.azure.storage.file.share.ShareFileClientBuilder httpClient(HttpClient httpClient) {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder addPolicy(HttpPipelinePolicy pipelinePolicy) {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder httpLogOptions(HttpLogOptions logOptions) {
     ...
     * @return the updated ShareFileClientBuilder object
     */
    public com.azure.storage.file.share.ShareFileClientBuilder configuration(Configuration configuration) {
     ...
     */
    public com.azure.storage.file.share.ShareFileClientBuilder retryOptions(RequestRetryOptions retryOptions) {
     ...
     * @return the updated ShareFileClientBuilder object
     */
    public com.azure.storage.file.share.ShareFileClientBuilder pipeline(HttpPipeline httpPipeline) {
     ...
     * @return the updated ShareFileClientBuilder object
     */
    public com.azure.storage.file.share.ShareFileClientBuilder serviceVersion(ShareServiceVersion version) {
