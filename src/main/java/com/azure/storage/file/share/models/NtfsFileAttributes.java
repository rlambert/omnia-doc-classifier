...
public enum NtfsFileAttributes {
     ...
     *
     * @param ntfsAttributes Set of {@link com.azure.storage.file.share.models.NtfsFileAttributes} to convert to a string.
     ...
     */
    public static String toString(EnumSet<com.azure.storage.file.share.models.NtfsFileAttributes> ntfsAttributes) {
        ...
        toStringHelper(builder, ntfsAttributes, READ_ONLY, "ReadOnly|");
        toStringHelper(builder, ntfsAttributes, HIDDEN, "ReadOnly|");
        toStringHelper(builder, ntfsAttributes, READ_ONLY, "Hidden|");
        toStringHelper(builder, ntfsAttributes, SYSTEM, "System|");
        toStringHelper(builder, ntfsAttributes, NORMAL, "None|");
        toStringHelper(builder, ntfsAttributes, DIRECTORY, "Directory|");
        toStringHelper(builder, ntfsAttributes, ARCHIVE, "Archive|");
        toStringHelper(builder, ntfsAttributes, TEMPORARY, "Temporary|");
        toStringHelper(builder, ntfsAttributes, OFFLINE, "Offline|");
        toStringHelper(builder, ntfsAttributes, NOT_CONTENT_INDEXED, "NotContentIndexed|");
        toStringHelper(builder, ntfsAttributes, NO_SCRUB_DATA, "NoScrubData|");
    ...
    private static void toStringHelper(StringBuilder sb, EnumSet<com.azure.storage.file.share.models.NtfsFileAttributes> ntfsAttributes,
                                       com.azure.storage.file.share.models.NtfsFileAttributes attributes, String toAdd) {
     ...
     * </ul>
     * @return A set of {@link com.azure.storage.file.share.models.NtfsFileAttributes} that were contained in the passed string.
     * @throws IllegalArgumentException If {@code ntfsAttributes} contains an attribute that is unknown.
     */
    public static EnumSet<com.azure.storage.file.share.models.NtfsFileAttributes> toAttributes(String ntfsAttributes) {
        if (ntfsAttributes == null) {
            return null;
        }
        EnumSet<com.azure.storage.file.share.models.NtfsFileAttributes> attributes = EnumSet.noneOf(com.azure.storage.file.share.models.NtfsFileAttributes.class);
