...
public final class ShareSasPermission {
     ...
     */
    public static com.azure.storage.file.share.sas.ShareSasPermission parse(String permissionString) {
        com.azure.storage.file.share.sas.ShareSasPermission permissions = new com.azure.storage.file.share.sas.ShareSasPermission();
     ...
     */
    public com.azure.storage.file.share.sas.ShareSasPermission setReadPermission(boolean hasReadPermission) {
     ...
     * @return the updated ShareSasPermission object
     */
    public com.azure.storage.file.share.sas.ShareSasPermission setCreatePermission(boolean hasCreatePermission) {
     ...
     * @return the updated ShareSasPermission object
     */
    public com.azure.storage.file.share.sas.ShareSasPermission setWritePermission(boolean hasWritePermission) {
     ...
     * @return the updated ShareSasPermission object
     */
    public com.azure.storage.file.share.sas.ShareSasPermission setDeletePermission(boolean hasDeletePermission) {
     ...
     * @return the updated ShareSasPermission object
     */
    public com.azure.storage.file.share.sas.ShareSasPermission setListPermission(boolean hasListPermission) {
