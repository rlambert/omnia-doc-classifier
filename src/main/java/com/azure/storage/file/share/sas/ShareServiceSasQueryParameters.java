 ...
 * by the user; it is only generated by the {@link ShareServiceSasSignatureValues} type. Once generated, it can be set
 * on a {@link ShareFileClientBuilder} object to be constructed as part of a URL or it can be encoded into a
...
public final class ShareServiceSasQueryParameters extends BaseSasQueryParameters {
    ...
    /**
     * Creates a new {@link com.azure.storage.file.share.sas.ShareServiceSasQueryParameters} object.
     *
    ...
    /**
     * Creates a new {@link com.azure.storage.file.share.sas.ShareServiceSasQueryParameters} object. These objects are only created internally by
